...
public class TrolleyPage extends DriverManager {
    ...
    public String getReserverNowButtonText(){return reseerveNowButton.getText();}

    public String getQtyFromReservationPage(){ return checkQtyAndPrice.getText().substring(7,8); }

    public String getPriceFromReservationPage(){ return checkQtyAndPrice.getText().substring(12,17); }
